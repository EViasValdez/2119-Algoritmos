...
public class Ciclo2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // La instrucion for indica que se comenzara con un ciclo y que
        // las instrucciones que estan detro de las llaves de for son las
        // que se repetiran mientras se cumpla la condicion de "contador <= 4"
        // para "contador = 0".
